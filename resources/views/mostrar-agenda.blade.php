...
<body>
    ...
    <form method="GET" action="{{ route('mostrar.agenda') }}">
        ...
        <br>
        <button type="submit" style="margin-top:1rem; margin-left:4rem; background-color: #337ab7; color: white; padding: 6px 10px; border-radius: 5px; text-decoration: none; display: inline-block; font-size: 12px;">Mostrar Agenda</button>
